...
CREATE TABLE SKILL_DETAIL (
  ...
  SKILL_DETAIL_REGISTRY_ID VARCHAR2(36 CHAR) NOT NULL,
  SKILL_DETAIL_ID VARCHAR2(36 CHAR) NOT NULL,
  SKILL_DETAIL_DESCRIPTION VARCHAR2(256 CHAR) NOT NULL,
  SKILL_DETAIL_PARENT_ID VARCHAR2(36 CHAR) DEFAULT NULL,
  SKILL_DETAIL_SOURCE VARCHAR2(8 CHAR) NOT NULL
);

CREATE INDEX IDX_SKILL_DETAIL_PROGRAM_ID ON SKILL_DETAIL (SKILL_DETAIL_PROGRAM_ID);
CREATE INDEX IDX_SKILL_DETAIL_REGISTRY_ID ON SKILL_DETAIL (SKILL_DETAIL_REGISTRY_ID);
CREATE INDEX IDX_SKILL_DETAIL_ID ON SKILL_DETAIL (SKILL_DETAIL_ID);
CREATE INDEX IDX_SKILL_DETAIL_PARENT_ID ON SKILL_DETAIL (SKILL_DETAIL_PARENT_ID);

GRANT SELECT ON SKILL_DETAIL TO PUBLIC;
